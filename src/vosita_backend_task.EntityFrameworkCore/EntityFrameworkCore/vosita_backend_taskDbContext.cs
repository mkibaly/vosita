...
public class vosita_backend_taskDbContext :
    AbpDbContext<vosita_backend_taskDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public vosita_backend_taskDbContext(DbContextOptions<vosita_backend_taskDbContext> options)
        : base(options)
    {
